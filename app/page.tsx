    ...
    <div>
      ...
      <section className="section grid items-center gap-10 lg:grid-cols-2">
        <div>
          ...
          <div className="mt-7 flex gap-3"><Button href="/app/assessment">Take the Signals Assessment</Button><Button href="/contact" variant="secondary">Book a Demo</Button></div>
        </div>
